...
class ShiftAvailability(models.Model):
    ...
    on_call_available = models.BooleanField(default=False, verbose_name='当直可')  # 当直可否
    on_call_comments = models.TextField(blank=True, verbose_name='当直コメント')  # 当直のコメント
    on_call_external_hospital = models.BooleanField(default=False, verbose_name='外病院当直可')  # 外病院当直可否
    on_call_external_hospital_comments = models.TextField(blank=True, verbose_name='外病院当直コメント')  # 外病院当直のコメント
